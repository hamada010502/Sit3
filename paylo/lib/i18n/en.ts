export const en = {
  ...
  checkout_signed_in_as: 'Signed in as {name} — your saved info pre-filled this order.',
  checkout_guest_hint: 'No account needed to buy — check out as a guest below. Sign in or create an account to save your address and see your order history next time.',
  checkout_guest_or: 'or continue as a guest below',
  create_account_btn: 'Create account',
  account_title: 'My account', account_profile: 'Profile', account_addresses: 'Addresses', account_orders: 'Order history',
  account_no_orders: "You haven't placed any orders on this account yet.",
  account_save_profile: 'Save changes',
  account_add_address: 'Add address', account_edit_address: 'Edit address', account_delete_address: 'Delete',
  account_default_address: 'Default', account_set_default: 'Make default', account_no_addresses: 'No saved addresses yet.',
  address_label: 'Label (optional)', address_label_hint: 'e.g. Home, Work',
  make_default_address: 'Make this my default address',
  account_link_order: 'Link a past guest order', account_link_order_intro: 'Placed an order as a guest before creating this account? Verify it and it will show up in your order history here.',
  account_link_order_code: 'Order code', account_link_order_contact: 'Email or phone used on that order',
  account_link_order_send_code: 'Send verification code', account_link_order_code_label: 'Verification code',
  account_link_order_confirm: 'Confirm and link order',
  account_link_order_code_sent: "If that matches, we've sent a 6-digit code to it. Enter it below to finish linking.",
  account_link_order_success: 'Order linked to your account.',
  account_link_order_error_cannot: "We couldn't verify that — check the order code and contact info, or the order may already be linked to an account.",
  account_link_order_error_expired: 'That code expired. Request a new one.',
  account_link_order_error_invalid: 'That code is incorrect.',
  account_link_order_error_attempts: 'Too many incorrect attempts. Request a new code.',
  account_view_order: 'View order',
  register_title: 'Create your account', register_benefit1: 'Save addresses for faster checkout',
  register_benefit2: 'See your full order history in one place', register_benefit3: 'Skip re-entering your details next time',
